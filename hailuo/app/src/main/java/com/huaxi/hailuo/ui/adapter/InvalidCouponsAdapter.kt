...
import kotlinx.android.synthetic.main.item_invalid_coupons_layout.view.*

/**
 * Created by wang on 2018/4/2.
 */
class InvalidCouponsAdapter(var activity: Activity, var data: MutableList<CouponListBean.CouponBean>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return CouponsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_invalid_coupons_layout, parent, false))
    }
