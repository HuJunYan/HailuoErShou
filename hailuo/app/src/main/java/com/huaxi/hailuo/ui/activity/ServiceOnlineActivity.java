...
import com.huaxi.hailuo.util.Config;
...
public class ServiceOnlineActivity extends SimpleActivity {
    ...
    protected void setStatusBar() {
        StatusBarUtil.immersive(this, getResources().getColor(R.color.colorPrimaryDark), 1F);
...
//        StatusBarUtil.setPaddingSmart(this, findViewById(R.id.tb_online));
    ...
    private void initWebView() {
        ...
        if (mBundle != null) {
            mUrl = mBundle.getString(SERVICE_ONLINE_KEY, "");
        }
