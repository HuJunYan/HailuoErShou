...
//        edit_content.setFocusable(isEdit);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (hasFocus) {
            view_line.setBackgroundResource(R.color.black);
        } else {
            view_line.setBackgroundResource(R.color.main_bottom_line_color);
        }
    }
...
//                        mTimer = new TimeCount(tv_verification, 60000, 1000, "重新获取", true);
//                        mTimer.start();
                    }
                }
                break;
    ...
    public void startTimer() {
        mTimer = new TimeCount(tv_verification, 60000, 1000, "重新获取", true, R.drawable.shape_circle);
        mTimer.start();
    }
    ...
    public void setHint(@NotNull String s) {
        edit_content.setHint(s);
    }

    public void setEditTextMaxLength(int length) {
        edit_content.setFilters(new InputFilter[]{new InputFilter.LengthFilter(length)});
    }
