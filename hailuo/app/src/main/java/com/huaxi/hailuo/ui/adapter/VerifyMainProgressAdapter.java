...
public class VerifyMainProgressAdapter extends BaseQuickAdapter<FlowBean,BaseViewHolder> {

    private List<FlowBean> mData;
    private Context mContext;

    public VerifyMainProgressAdapter(Context context, @Nullable List<FlowBean> data) {
        super( R.layout.item_verify_main_progress, data);
