...
import com.huaxi.hailuo.presenter.impl.AuthInfoPresenter
...
class AuthInfoActivity : BaseActivity<AuthInfoContract.View, AuthInfoContract.Presenter>(), AuthInfoContract.View {
    ...
    override var mPresenter: AuthInfoContract.Presenter = AuthInfoPresenter()
    ...
    override fun initView() {
        ...
        tv_auth_info_back.setOnClickListener({
            backActivity()
        })
