...
public class EncodeUtil {
    ...
    public static String SHA1MD5AndReverse(String Number) {
        String sha1number = getSHA1(Number).toLowerCase();
        StringBuffer sb = new StringBuffer(md5(sha1number));
        String key = sb.reverse().toString();
        return key;
    }

    public static String MD5SHA1AndReverse(String Number) {
        String md5Number = md5(Number).toLowerCase();
        String sha1Number = getSHA1(md5Number);
